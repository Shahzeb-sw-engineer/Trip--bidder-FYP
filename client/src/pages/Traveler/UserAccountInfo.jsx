...
export default function UserAccountInfo() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        // if (data.fullname.length === 0 || data.phone.length === 0 || data.country.length === 0 || data.state.length === 0 || data.city.length === 0) {
        //     showAlert('Fill out empty fields', 'danger')
        //     return
        // }
        console.log(data)
        // navigate('/businessinfo', { state: { personalinfo: data } })
        // console.log(data)
    }
            ...
            <section className='register accountInfo'>
                <div className="info-container">
                    ...
                    <form action="" className="info-form" onSubmit={handleSubmit}>
                        <div className="side">
                            <div className="chooseimage px-3 mb-4" onClick={handleImage}>
                        ...
                        <div className="side">
                            ...
                            <button className="btn-custom float-end mb-3" >Submit</button>
